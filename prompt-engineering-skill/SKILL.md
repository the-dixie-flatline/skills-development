...
| Gemini  | published    | published | 3.5 Flash GA + 3.1 Flash-Lite GA + 3.1 Pro Preview. Interactions API is the primary surface (GA 2026-06-22, SDK >= 2.3.0, snake_case; `tool_choice`/`thinking_level`/`response_format` under `generation_config`); `generateContent` legacy-but-supported (still receiving mainline models). thinkingLevel replaces thinkingBudget on Gemini 3; 2.0 GA shut down 2026-06-01, 2.5 GA sunsets 2026-10-16. As of 2026-07-19 |
